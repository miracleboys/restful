...
<body>
    ...
    <div class="leftimg"><a href="template.jsp" target="view"><img src="../images/ui/userList.png" style="width: 80px ; height: 80px;"></a></div>
    <div class="leftimg"><a href="" target="view"><img src="../images/ui/catalog.png" style="width: 80px ; height: 80px;"></a></div>
